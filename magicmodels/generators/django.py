...
class DjangoGenerator(BaseGenerator):
    ...
    def generate(self, models: List[Model], output_dir: str) -> None:
        ...
        for model in models:
            ...
            views_code += "from rest_framework.permissions import IsAuthenticatedOrReadOnly, AllowAny\n"
            views_code += "from .models import *\nfrom .serializers import *\n\n"
...
SECRET_KEY = 'django-insecure-magicmodels'
DEBUG = True
ALLOWED_HOSTS = ['*']
