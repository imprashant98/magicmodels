...
def create_post(item: Post, service: PostService = Depends(get_service), current_user: dict = Depends(get_current_user)):
...
def read_post(item_id: int, service: PostService = Depends(get_service)):
...
def update_post(item_id: int, item_data: Post, service: PostService = Depends(get_service), current_user: dict = Depends(get_current_user)):
...
def delete_post(item_id: int, service: PostService = Depends(get_service), current_user: dict = Depends(get_current_user)):
